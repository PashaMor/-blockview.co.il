...
(function () {
  ...
  const T = {
    he: {
      ...
      ev_new_listing: "נכס חדש פורסם בבניין", ev_price_drop: "ירידת מחיר בנכס בבניין", ev_sold: "נכס בבניין סומן כנמכר", ev_frozen: "נכס בבניין הוקפא", rt_today: "היום", rt_yesterday: "אתמול", alerts_none_yet: "אין עדיין עדכונים", unfollow: "ביטול מעקב", view_building: "צפייה בבניין",
      ...
      yearly: "שנתי", monthly: "חודשי", save42: "חסכון 57%", upgrade_now: "שדרג עכשיו", maybe_later: "אולי מאוחר יותר",
      ...
      save: "♥ שמור", share: "🔗 שתף", send_msg: "שליחת הודעה", language: "שפה", for_sale: "למכירה", for_rent: "להשכרה", rent_term: "תקופת השכירות", term_short: "טווח קצר \\ סאבלט", term_long: "טווח ארוך", term_hint: "טווח קצר — השכרה לימים או שבועות. טווח ארוך — חוזה שכירות רגיל.",
      publish: "פרסם נכס", who_q: "מי אתה?", who_sub: "בחר כדי להמשיך לפרסום הנכס", owner: "בעל נכס", owner_desc: "פרסם את הנכס שלך בעצמך", realtor: "מתווך / סוכן", realtor_desc: "מעבר למערכת הסוכנים", publish_title: "פרסום נכס", publish_sub: "הנכס יישלח לאישור ויופיע במפה לאחר אישור.", pub_title_lbl: "כותרת", price_lbl: "מחיר (₪)", size_lbl: "מ\"ר", floor_lbl: "קומה", photos_lbl: "תמונות", submit_listing: "שלח לאישור", login_to_publish: "התחבר כדי לפרסם נכס", pub_ok: "הנכס נשלח לאישור ✓", wa_has: "💬 המספר זמין בוואטסאפ", wa_contact: "💬 וואטסאפ", wa_none: "אין מספר וואטסאפ לנכס הזה", wa_msg: "שלום! ראיתי את הנכס \"{title}\" ב{address} דרך BlockView ואשמח לפרטים נוספים.\n{url}", contact_lbl: "פרטי יצירת קשר", contact_name: "שם איש קשר", contact_phone: "טלפון", contact_email: "אימייל (לא חובה)", contact_hint: "גולשים שאינם מחוברים יראו את הפרטים באופן חלקי בלבד. משתמשים מחוברים יראו את הפרטים המלאים.", contact_name_bad: "נא למלא שם איש קשר", contact_phone_bad: "נא למלא מספר טלפון תקין", contact_owner: "יצירת קשר", lead_title: "שליחת פנייה", lead_name: "השם שלך", lead_phone: "טלפון", lead_email: "אימייל", lead_msg: "הודעה (לא חובה)", lead_send: "📩 שלח פנייה", lead_hint: "הפנייה תישלח לבעל הנכס בלבד, יחד עם הטלפון או האימייל שהזנת.", lead_ok: "הפנייה נשלחה ✓ בעל הנכס יחזור אליך", lead_error: "שליחת הפנייה נכשלה, נסה שוב", lead_too_many: "נשלחו יותר מדי פניות לנכס הזה. נסה שוב בעוד שעה.", lead_name_bad: "נא למלא את שמך", lead_phone_bad: "מספר טלפון לא תקין", lead_reach_bad: "יש למלא טלפון או אימייל כדי שנוכל לחזור אליך", address_lbl: "כתובת הנכס", address_ph: "רחוב ומספר, עיר", address_hint: "חפש את הכתובת — הבניין ייווצר אוטומטית לפי מפת OpenStreetMap.", pick_existing: "בחירה מרשימת בניינים", address_none: "לא נמצאה כתובת. נסה ניסוח אחר.", address_checking: "מאתר את מתאר הבניין…", address_ok: "נמצא מתאר בניין אמיתי", address_nofp: "ללא מתאר מדויק, ימוקם לפי הכתובת", address_required: "נא לבחור את כתובת הנכס", address_need_number: "⛔ חובה לבחור כתובת עם מספר בית. הכנסת מספר הבניין מאפשר למערכת להראות כל מה שמסביב לבניין במדויק.", address_area_ok: "יישוב / אזור נבחר", address_toomany: "נוצרו יותר מדי בניינים. נסה שוב בעוד שעה.", price_bad: "נא למלא מחיר תקין", price_max: "המחיר המרבי הוא ₪99,000,000", confirm: "אישור", cancel: "ביטול", are_you_sure: "לאשר את הפעולה?", del_listing_q: "למחוק את הנכס?", cover: "תמונה ראשית", make_cover: "הפוך לתמונה ראשית", cover_failed: "עדכון התמונה הראשית נכשל", agent_apply_first: "יש להירשם כסוכן ולקבל אישור מנהל", agent_account: "חשבון סוכן", agent_account_sub: "ניהול הנכסים, הלידים והמיתוג שלך", go_to_crm: "🧑‍💼 מעבר ל-CRM", agent_pending: "בקשת הסוכן ממתינה לאישור", agent_pending_sub: "נעדכן אותך כשמנהל המערכת יבדוק אותה", agent_rejected: "הבקשה נדחתה", agent_rejected_sub: "אפשר לתקן ולשלוח שוב", are_you_agent: "אתה מתווך?", are_you_agent_sub: "הירשם כסוכן וקבל CRM לניהול נכסים ולידים", agent_register: "הרשמה כסוכן", view_edit: "צפייה ועריכה", apply_again: "שליחה מחדש", agent_apply_title: "בקשה להצטרף כסוכן", agent_apply_sub: "מלא את הפרטים; מנהל המערכת יאשר את החשבון וייפתח לך CRM מלא.", agent_apply_send: "שלח בקשה", agent_apply_ok: "הבקשה נשלחה ✓", agent_apply_failed: "שליחת הבקשה נכשלה", first_name: "שם פרטי *", last_name: "שם משפחה *", agency: "משרד / סוכנות *", license_no: "מספר רישיון תיווך *", phone: "טלפון *", agency_logo: "לוגו המשרד *", agency_logo_hint: "יופיע על הנכסים שתפרסם. נדחס אוטומטית.", note_to_admin: "הערה למנהל", admin_note: "הערת מנהל", logo_required: "נא להעלות את לוגו המשרד", login_first: "יש להתחבר תחילה", get_the_app: "קבל את האפליקציה", get_it_on: "הורד מ־", download_on: "הורד מ־", app_coming_soon: "האפליקציה תהיה זמינה בקרוב 📲", balcony: "🌇 מרפסת", yard: "🌳 חצר", balcony_size: "גודל מרפסת (מ\"ר)", yard_size: "גודל חצר (מ\"ר)", home_loc: "מיקום הבית", home_loc_none: "לא הוגדר — כפתור האיפוס חוזר למרכז תל אביב", home_loc_ph: "חפש כתובת להגדרת בית", home_loc_saved: "מיקום הבית נשמר ✓ כפתור האיפוס יביא לכאן", home_loc_cleared: "מיקום הבית נמחק", home_loc_failed: "שמירת המיקום נכשלה", show_contact: "התחבר לצפייה", contact_locked: "פרטי הקשר המלאים גלויים למשתמשים מחוברים בלבד.", add_contact: "＋ הוסף איש קשר", remove_contact: "הסר איש קשר", contacts_ttl: "אנשי קשר", forgot_pw: "שכחת סיסמה?", change_pw: "🔑 שינוי סיסמה", agent_listings: "הנכסים של הסוכן", report_listing: "🚩 דיווח", report_eyebrow: "דיווח", report_title: "דיווח על נכס", report_reason: "סיבת הדיווח", report_r_unavailable: "הנכס כבר לא זמין / נמכר", report_r_wrong_price: "המחיר שגוי או מטעה", report_r_wrong_details: "פרטים שגויים", report_r_photos: "תמונות מטעות", report_r_scam: "חשד להונאה / ספאם", report_r_offensive: "תוכן פוגעני", report_r_other: "אחר", report_details: "פירוט (לא חובה)", report_hint: "הדיווח יישלח לבעל הנכס ולצוות BlockView לבדיקה.", report_send: "שלח דיווח", report_ok: "הדיווח נשלח ✓ תודה, נבדוק אותו", report_error: "שליחת הדיווח נכשלה, נסה שוב", report_too_many: "התקבלו יותר מדי דיווחים על הנכס הזה. נסה שוב בעוד שעה.", in_property: "מה יש בנכס", share_building: "🔗 שתף", in_area: "באזור", draw_hint: "ציירו אזור על המפה כדי לסנן נכסים", draw_erase: "🧽 מחק", draw_done: "✓ אישור", area_eyebrow: "אזור מסומן", area_title: "נכסים באזור", area_redraw: "✏️ צייר מחדש", area_clear: "✕ נקה אזור", area_empty: "אין נכסים באזור שסימנת.", avail_from: "זמין מתאריך", avail_to: "עד תאריך", avail_filter: "זמינות (להשכרה)",
      legal_agree: "בהמשך אתה מאשר את", terms_link: "תנאי השימוש", privacy_link: "מדיניות הפרטיות", and: "ו",
      virtual_tour: "סיור וירטואלי", listing_website: "עמוד הנכס באתר",
      st_frozen: "מוקפא — מוסתר זמנית",
      loading: "טוען…", open_in_browser: "פתח בדפדפן",
      a11y_link: "הצהרת נגישות", cancel: "ביטול", confirm: "אישור", lead_share: "אני מאשר/ת שפרטי הפנייה יועברו גם למתווכים ולנותני שירות נוספים שעשויים להציע לי נכסים דומים או מימון. אינך חייב/ת לסמן — הפנייה תישלח לבעל הנכס בכל מקרה.",
      ...
      floors_total_lbl: "מתוך כמה קומות", category_lbl: "ייעוד", residential: "מגורים", commercial: "מסחרי", agricultural: "חקלאי", farm: "משק חקלאי", orchard: "מטע", vineyard: "כרם", field: "שדה / קרקע חקלאית", pick_on_map: "📍 בחר מיקום על המפה", pick_hint: "מקם את הסימון על המשק ואשר", address_ph_farm: "יישוב / עיר", farm_here: "משק חקלאי (מיקום נבחר)", pin_set: "מיקום נבחר על המפה", parcel_ph: "גוש / חלקה (לא חובה)", pin_required: "יש לסמן את מיקום המשק על המפה לפני שליחה לאישור", penthouse: "פנטהאוז", studio: "סטודיו", office: "משרד", shop: "חנות", warehouse: "מחסן / לוגיסטיקה", other_type: "אחר",
      write_for_me: "✨ נסח לי תיאור", write_hint: "הניסוח נבנה מהפרטים שמילאת — אפשר לערוך אותו כרצונך.", write_need_fields: "מלא חדרים ושטח כדי לנסח תיאור", write_need_size: "מלא שטח כדי לנסח תיאור", write_done: "נוסח תיאור — אפשר לערוך", write_replace: "להחליף את התיאור שכתבת?",
      delete_account: "מחיקת החשבון", delete_confirm_btn: "מחק לצמיתות", delete_warn: "למחוק את החשבון לצמיתות? יימחקו הנכסים שפרסמת, התמונות, המועדפים וההערות שלך. הפעולה אינה הפיכה.", delete_prompt: "לאישור סופי הקלד את כתובת האימייל שלך:", delete_mismatch: "האימייל לא תואם — החשבון לא נמחק", delete_done: "החשבון נמחק", delete_failed: "מחיקת החשבון נכשלה, נסה שוב", delete_last_admin: "זהו חשבון המנהל האחרון ולכן אי אפשר למחוק אותו",
    ...
    en: {
      ...
      ev_new_listing: "New listing posted in this building", ev_price_drop: "Price cut on a listing here", ev_sold: "A listing here was marked sold", ev_frozen: "A listing here was paused", rt_today: "Today", rt_yesterday: "Yesterday", alerts_none_yet: "No updates yet", unfollow: "Unfollow", view_building: "View building",
      ...
      yearly: "Yearly", monthly: "Monthly", save42: "Save 57%", upgrade_now: "Upgrade now", maybe_later: "Maybe later",
      ...
      save: "♥ Save", share: "🔗 Share", send_msg: "Send message", language: "Language", for_sale: "For sale", for_rent: "For rent", rent_term: "Rental term", term_short: "Short-term", term_long: "Long-term", term_hint: "Short-term — nightly or weekly. Long-term — an ordinary lease.",
      publish: "List a property", who_q: "Who are you?", who_sub: "Choose how to continue", owner: "Property owner", owner_desc: "Post your own property", realtor: "Realtor / agent", realtor_desc: "Go to the agent CRM", publish_title: "Publish a property", publish_sub: "Your listing is reviewed, then appears on the map.", pub_title_lbl: "Title", price_lbl: "Price (₪)", size_lbl: "m²", floor_lbl: "Floor", photos_lbl: "Photos", submit_listing: "Submit for approval", login_to_publish: "Sign in to publish", pub_ok: "Submitted for approval ✓", wa_has: "💬 This number is on WhatsApp", wa_contact: "💬 WhatsApp", wa_none: "No WhatsApp number for this listing", wa_msg: "Hi! I saw the property \"{title}\" at {address} on BlockView and would love more details.\n{url}", contact_lbl: "Contact details", contact_name: "Contact name", contact_phone: "Phone", contact_email: "Email (optional)", contact_hint: "Visitors who are not signed in see these details only partially; signed-in users see them in full.", contact_name_bad: "Please enter a contact name", contact_phone_bad: "Please enter a valid phone number", contact_owner: "Get in touch", lead_title: "Send an enquiry", lead_name: "Your name", lead_phone: "Phone", lead_email: "Email", lead_msg: "Message (optional)", lead_send: "📩 Send enquiry", lead_hint: "Your enquiry goes only to the property owner, with the phone or email you enter.", lead_ok: "Enquiry sent ✓ the owner will get back to you", lead_error: "Could not send the enquiry, please try again", lead_too_many: "Too many enquiries on this listing. Try again in an hour.", lead_name_bad: "Please enter your name", lead_phone_bad: "Invalid phone number", lead_reach_bad: "Enter a phone or an email so we can reply", address_lbl: "Property address", address_ph: "Street and number, city", address_hint: "Search the address — the building is created automatically from OpenStreetMap.", pick_existing: "Pick from existing buildings", address_none: "No address found. Try different wording.", address_checking: "Looking up the building outline…", address_ok: "Real building outline found", address_nofp: "No exact outline, placed by address", address_required: "Please pick the property address", address_need_number: "⛔ You must pick an address with a house number. The house number lets us show exactly what's around the building.", address_area_ok: "Settlement / area selected", address_toomany: "Too many buildings created. Try again in an hour.", price_bad: "Please enter a valid price", price_max: "The maximum price is ₪99,000,000", confirm: "Confirm", cancel: "Cancel", are_you_sure: "Are you sure?", del_listing_q: "Delete this listing?", cover: "Cover photo", make_cover: "Make cover photo", cover_failed: "Could not update the cover photo", agent_apply_first: "Apply as an agent and get admin approval first", agent_account: "Agent account", agent_account_sub: "Manage your listings, leads and branding", go_to_crm: "🧑‍💼 Go to the CRM", agent_pending: "Agent application pending", agent_pending_sub: "We'll update you once an admin reviews it", agent_rejected: "Application rejected", agent_rejected_sub: "You can fix it and resend", are_you_agent: "Are you a realtor?", are_you_agent_sub: "Register as an agent and get a CRM for listings and leads", agent_register: "Register as an agent", view_edit: "View / edit", apply_again: "Send again", agent_apply_title: "Apply to join as an agent", agent_apply_sub: "Fill in the details; an admin approves the account and opens the full CRM.", agent_apply_send: "Send application", agent_apply_ok: "Application sent ✓", agent_apply_failed: "Could not send the application", first_name: "First name *", last_name: "Last name *", agency: "Agency / firm *", license_no: "Broker licence number *", phone: "Phone *", agency_logo: "Agency logo *", agency_logo_hint: "Shown on the listings you publish. Compressed automatically.", note_to_admin: "Note to the admin", admin_note: "Admin note", logo_required: "Please upload the agency logo", login_first: "Please sign in first", get_the_app: "Get the app", get_it_on: "GET IT ON", download_on: "Download on the", app_coming_soon: "The app will be available soon 📲", balcony: "🌇 Balcony", yard: "🌳 Yard", balcony_size: "Balcony size (m²)", yard_size: "Yard size (m²)", home_loc: "Home location", home_loc_none: "Not set — reset returns to central Tel Aviv", home_loc_ph: "Search an address to set home", home_loc_saved: "Home saved ✓ reset will bring you here", home_loc_cleared: "Home location cleared", home_loc_failed: "Could not save the location", show_contact: "Sign in to view", contact_locked: "Full contact details are visible to signed-in users only.", add_contact: "＋ Add contact", remove_contact: "Remove contact", contacts_ttl: "Contacts", forgot_pw: "Forgot password?", change_pw: "🔑 Change password", agent_listings: "Agent's listings", report_listing: "🚩 Report", report_eyebrow: "Report", report_title: "Report a listing", report_reason: "Reason", report_r_unavailable: "No longer available / sold", report_r_wrong_price: "Wrong or misleading price", report_r_wrong_details: "Incorrect details", report_r_photos: "Misleading photos", report_r_scam: "Suspected scam / spam", report_r_offensive: "Offensive content", report_r_other: "Other", report_details: "Details (optional)", report_hint: "The report goes to the listing owner and the BlockView team for review.", report_send: "Send report", report_ok: "Report sent ✓ thank you, we'll review it", report_error: "Could not send the report, please try again", report_too_many: "Too many reports on this listing. Try again in an hour.", in_property: "In the property", share_building: "🔗 Share", in_area: "in area", draw_hint: "Draw an area on the map to filter listings", draw_erase: "🧽 Erase", draw_done: "✓ Done", area_eyebrow: "Selected area", area_title: "Listings in area", area_redraw: "✏️ Redraw", area_clear: "✕ Clear area", area_empty: "No listings in the area you drew.", avail_from: "Available from", avail_to: "Until", avail_filter: "Availability (rentals)",
      legal_agree: "By continuing you accept the", terms_link: "Terms of Service", privacy_link: "Privacy Policy", and: "and ",
      virtual_tour: "Virtual tour", listing_website: "Listing on the web",
      st_frozen: "Frozen — temporarily hidden",
      loading: "Loading…", open_in_browser: "Open in browser",
      a11y_link: "Accessibility statement", cancel: "Cancel", confirm: "Confirm", lead_share: "I agree that my enquiry may also be passed to other agents and service providers who may offer me similar properties or financing. Ticking this is optional — the enquiry reaches the property owner either way.",
      ...
      floors_total_lbl: "Out of how many floors", category_lbl: "Use", residential: "Residential", commercial: "Commercial", agricultural: "Agricultural", farm: "Farm", orchard: "Orchard", vineyard: "Vineyard", field: "Field / farmland", penthouse: "Penthouse", studio: "Studio", office: "Office", shop: "Shop", warehouse: "Warehouse", other_type: "Other",
    ...
    ar: {
      ...
      ev_new_listing: "عقار جديد نُشر في هذا المبنى", ev_price_drop: "انخفاض سعر عقار في هذا المبنى", ev_sold: "تم بيع عقار في هذا المبنى", ev_frozen: "تم تجميد عقار في هذا المبنى", rt_today: "اليوم", rt_yesterday: "أمس", alerts_none_yet: "لا توجد تحديثات بعد", unfollow: "إلغاء المتابعة", view_building: "عرض المبنى",
      ...
      yearly: "سنوي", monthly: "شهري", save42: "وفّر 57%", upgrade_now: "الترقية الآن", maybe_later: "ربما لاحقاً",
      ...
      save: "♥ حفظ", share: "🔗 مشاركة", send_msg: "إرسال رسالة", language: "اللغة", for_sale: "للبيع", for_rent: "للإيجار", rent_term: "مدة الإيجار", term_short: "قصير المدى", term_long: "طويل المدى", term_hint: "قصير المدى — بالأيام أو الأسابيع. طويل المدى — عقد إيجار عادي.",
      publish: "أضف عقارًا", who_q: "من أنت؟", who_sub: "اختر لمتابعة النشر", owner: "مالك العقار", owner_desc: "انشر عقارك بنفسك", realtor: "وسيط عقاري", realtor_desc: "الانتقال إلى نظام الوسطاء", publish_title: "نشر عقار", publish_sub: "سيُراجع العقار ثم يظهر على الخريطة.", pub_title_lbl: "العنوان", price_lbl: "السعر (₪)", size_lbl: "م²", floor_lbl: "الطابق", photos_lbl: "الصور", submit_listing: "إرسال للموافقة", login_to_publish: "سجّل الدخول للنشر", pub_ok: "تم الإرسال للموافقة ✓", wa_has: "💬 هذا الرقم متاح على واتساب", wa_contact: "💬 واتساب", wa_none: "لا يوجد رقم واتساب لهذا العقار", wa_msg: "مرحباً! رأيت العقار \"{title}\" في {address} عبر BlockView وأود مزيداً من التفاصيل.\n{url}", forgot_pw: "نسيت كلمة المرور؟", change_pw: "🔑 تغيير كلمة المرور", agent_listings: "عقارات الوكيل",
      legal_agree: "بالمتابعة فإنك توافق على", terms_link: "شروط الاستخدام", privacy_link: "سياسة الخصوصية", and: "و",
      virtual_tour: "جولة افتراضية", listing_website: "صفحة العقار على الويب",
      st_frozen: "مجمّد — مخفي مؤقتًا",
      loading: "جارٍ التحميل…", open_in_browser: "فتح في المتصفح",
      contact_owner: "تواصل", lead_title: "إرسال استفسار", lead_name: "اسمك", lead_phone: "هاتف", lead_email: "بريد إلكتروني", lead_msg: "رسالة (اختياري)", lead_hint: "يُرسل الاستفسار إلى مالك العقار فقط، مع الهاتف أو البريد الذي أدخلته.", lead_send: "📩 إرسال الاستفسار", address_lbl: "عنوان العقار", address_ph: "الشارع والرقم، المدينة", address_hint: "ابحث عن العنوان — سيُنشأ المبنى تلقائيًا حسب خريطة OpenStreetMap.", contact_lbl: "تفاصيل التواصل", add_contact: "＋ إضافة جهة اتصال", contact_hint: "الزوّار غير المسجّلين يرون التفاصيل جزئيًا فقط. المستخدمون المسجّلون يرون التفاصيل كاملة.",
      a11y_link: "بيان إمكانية الوصول", cancel: "إلغاء", confirm: "تأكيد", lead_share: "أوافق على تمرير تفاصيل طلبي إلى وسطاء ومزوّدي خدمات آخرين قد يعرضون عليّ عقارات مشابهة أو تمويلًا. هذا الاختيار ليس إلزاميًا — سيصل طلبك إلى مالك العقار في كل الأحوال.",
      ...
      floors_total_lbl: "من أصل كم طابق", category_lbl: "الاستخدام", residential: "سكني", commercial: "تجاري", agricultural: "زراعي", farm: "مزرعة", orchard: "بستان", vineyard: "كرم", field: "حقل / أرض زراعية", penthouse: "بنتهاوس", studio: "استوديو", office: "مكتب", shop: "محل", warehouse: "مستودع", other_type: "آخر",
    ...
    fr: {
      ...
      ev_new_listing: "Nouvelle annonce dans ce bâtiment", ev_price_drop: "Baisse de prix sur une annonce ici", ev_sold: "Une annonce ici a été vendue", ev_frozen: "Une annonce ici a été suspendue", rt_today: "Aujourd'hui", rt_yesterday: "Hier", alerts_none_yet: "Aucune mise à jour", unfollow: "Ne plus suivre", view_building: "Voir le bâtiment",
      ...
      yearly: "Annuel", monthly: "Mensuel", save42: "-57 %", upgrade_now: "Passer à Pro", maybe_later: "Plus tard",
      ...
      virtual_tour: "Visite virtuelle", listing_website: "Annonce sur le web",
      st_frozen: "Gelé — masqué temporairement",
      loading: "Chargement…", open_in_browser: "Ouvrir dans le navigateur",
      contact_owner: "Contact", lead_title: "Envoyer une demande", lead_name: "Votre nom", lead_phone: "Téléphone", lead_email: "E-mail", lead_msg: "Message (facultatif)", lead_hint: "La demande est envoyée uniquement au propriétaire, avec le téléphone ou l’e-mail que vous avez saisi.", lead_send: "📩 Envoyer la demande", address_lbl: "Adresse du bien", address_ph: "Rue et numéro, ville", address_hint: "Recherchez l’adresse — le bâtiment est créé automatiquement d’après OpenStreetMap.", contact_lbl: "Coordonnées", add_contact: "＋ Ajouter un contact", contact_hint: "Les visiteurs non connectés ne voient les coordonnées que partiellement. Les utilisateurs connectés les voient en entier.",
      a11y_link: "Déclaration d’accessibilité", cancel: "Annuler", confirm: "Confirmer", lead_share: "J’accepte que ma demande soit également transmise à d’autres agents et prestataires susceptibles de me proposer des biens similaires ou un financement. Cette case est facultative : votre demande parvient au propriétaire dans tous les cas.",
      ...
      floors_total_lbl: "Sur combien d’étages", category_lbl: "Usage", residential: "Résidentiel", commercial: "Commercial", agricultural: "Agricole", farm: "Ferme", orchard: "Verger", vineyard: "Vignoble", field: "Champ / terre agricole", penthouse: "Penthouse", studio: "Studio", office: "Bureau", shop: "Local commercial", warehouse: "Entrepôt", other_type: "Autre",
    ...
    ru: {
      ...
      ev_new_listing: "Новое объявление в этом здании", ev_price_drop: "Снижение цены в объявлении здесь", ev_sold: "Объявление здесь продано", ev_frozen: "Объявление здесь приостановлено", rt_today: "Сегодня", rt_yesterday: "Вчера", alerts_none_yet: "Пока нет обновлений", unfollow: "Отписаться", view_building: "Открыть здание",
      ...
      yearly: "Год", monthly: "Месяц", save42: "-57%", upgrade_now: "Перейти на Pro", maybe_later: "Позже",
      ...
      save: "♥ Сохранить", share: "🔗 Поделиться", send_msg: "Отправить сообщение", language: "Язык", for_sale: "Продажа", for_rent: "Аренда", rent_term: "Срок аренды", term_short: "Краткосрочно", term_long: "Долгосрочно", term_hint: "Краткосрочно — на дни или недели. Долгосрочно — обычный договор.",
      publish: "Разместить объект", who_q: "Кто вы?", who_sub: "Выберите, как продолжить", owner: "Собственник", owner_desc: "Разместите свой объект сами", realtor: "Риелтор / агент", realtor_desc: "Перейти в CRM для агентов", publish_title: "Размещение объекта", publish_sub: "Объявление проходит модерацию и появляется на карте.", pub_title_lbl: "Заголовок", price_lbl: "Цена (₪)", size_lbl: "м²", floor_lbl: "Этаж", photos_lbl: "Фото", submit_listing: "Отправить на модерацию", login_to_publish: "Войдите, чтобы разместить", pub_ok: "Отправлено на модерацию ✓", wa_has: "💬 Этот номер есть в WhatsApp", wa_contact: "💬 WhatsApp", wa_none: "У этого объекта нет WhatsApp", wa_msg: "Здравствуйте! Я увидел объект \"{title}\" по адресу {address} на BlockView и хотел бы узнать подробности.\n{url}", forgot_pw: "Забыли пароль?", change_pw: "🔑 Сменить пароль", agent_listings: "Объекты агента",
      legal_agree: "Продолжая, вы принимаете", terms_link: "Условия использования", privacy_link: "Политику конфиденциальности", and: "и ",
      virtual_tour: "Виртуальный тур", listing_website: "Объявление на сайте",
      st_frozen: "Заморожено — временно скрыто",
      loading: "Загрузка…", open_in_browser: "Открыть в браузере",
      contact_owner: "Связаться", lead_title: "Отправить обращение", lead_name: "Ваше имя", lead_phone: "Телефон", lead_email: "Эл. почта", lead_msg: "Сообщение (необязательно)", lead_hint: "Обращение получит только владелец объекта, вместе с указанным вами телефоном или почтой.", lead_send: "📩 Отправить обращение", address_lbl: "Адрес объекта", address_ph: "Улица и номер, город", address_hint: "Найдите адрес — здание создастся автоматически по данным OpenStreetMap.", contact_lbl: "Контактные данные", add_contact: "＋ Добавить контакт", contact_hint: "Незарегистрированные посетители видят данные лишь частично. Вошедшие в аккаунт видят их полностью.",
      a11y_link: "Заявление о доступности", cancel: "Отмена", confirm: "Подтвердить", lead_share: "Я согласен(на), что моё обращение может быть передано другим агентам и поставщикам услуг, которые могут предложить похожие объекты или финансирование. Отметка необязательна — обращение в любом случае получит владелец объекта.",
      ...
      floors_total_lbl: "Из скольких этажей", category_lbl: "Назначение", residential: "Жильё", commercial: "Коммерция", agricultural: "Сельхоз", farm: "Ферма", orchard: "Сад", vineyard: "Виноградник", field: "Поле / с/х земля", penthouse: "Пентхаус", studio: "Студия", office: "Офис", shop: "Магазин", warehouse: "Склад", other_type: "Другое",
      ...
      delete_account: "Удалить аккаунт", delete_confirm_btn: "Удалить навсегда", delete_warn: "Удалить аккаунт навсегда? Ваши объявления, фотографии, избранное и заметки будут удалены. Отменить это нельзя.", delete_prompt: "Для подтверждения введите свой адрес электронной почты:", delete_mismatch: "Адрес не совпадает — аккаунт не удалён", delete_done: "Аккаунт удалён", delete_failed: "Не удалось удалить аккаунт, попробуйте ещё раз", delete_last_admin: "Это последний аккаунт администратора, его нельзя удалить",
    ...
    es: {
      ...
      ev_new_listing: "Nuevo anuncio en este edificio", ev_price_drop: "Bajada de precio en un anuncio aquí", ev_sold: "Un anuncio aquí se marcó como vendido", ev_frozen: "Un anuncio aquí se pausó", rt_today: "Hoy", rt_yesterday: "Ayer", alerts_none_yet: "Aún no hay novedades", unfollow: "Dejar de seguir", view_building: "Ver edificio",
      ...
      yearly: "Anual", monthly: "Mensual", save42: "Ahorra 57%", upgrade_now: "Pasar a Pro", maybe_later: "Quizás más tarde",
      ...
      save: "♥ Guardar", share: "🔗 Compartir", send_msg: "Enviar mensaje", language: "Idioma", for_sale: "En venta", for_rent: "En alquiler", rent_term: "Tipo de alquiler", term_short: "Corto plazo", term_long: "Largo plazo", term_hint: "Corto plazo — por días o semanas. Largo plazo — contrato habitual.",
      publish: "Publicar propiedad", who_q: "¿Quién eres?", who_sub: "Elige cómo continuar", owner: "Propietario", owner_desc: "Publica tu propia propiedad", realtor: "Agente inmobiliario", realtor_desc: "Ir al CRM de agentes", publish_title: "Publicar propiedad", publish_sub: "Tu anuncio se revisa y luego aparece en el mapa.", pub_title_lbl: "Título", price_lbl: "Precio (₪)", size_lbl: "m²", floor_lbl: "Piso", photos_lbl: "Fotos", submit_listing: "Enviar a aprobación", login_to_publish: "Inicia sesión para publicar", pub_ok: "Enviado a aprobación ✓", wa_has: "💬 Este número tiene WhatsApp", wa_contact: "💬 WhatsApp", wa_none: "Esta propiedad no tiene WhatsApp", wa_msg: "¡Hola! Vi la propiedad \"{title}\" en {address} en BlockView y me gustaría más información.\n{url}", forgot_pw: "¿Olvidaste tu contraseña?", change_pw: "🔑 Cambiar contraseña", agent_listings: "Propiedades del agente",
      legal_agree: "Al continuar aceptas los", terms_link: "Términos de servicio", privacy_link: "Política de privacidad", and: "y ",
      virtual_tour: "Visita virtual", listing_website: "Anuncio en la web",
      st_frozen: "Congelado — oculto temporalmente",
      loading: "Cargando…", open_in_browser: "Abrir en el navegador",
      contact_owner: "Contacto", lead_title: "Enviar consulta", lead_name: "Tu nombre", lead_phone: "Teléfono", lead_email: "Correo electrónico", lead_msg: "Mensaje (opcional)", lead_hint: "La consulta se envía solo al propietario, junto con el teléfono o el correo que indicaste.", lead_send: "📩 Enviar consulta", address_lbl: "Dirección del inmueble", address_ph: "Calle y número, ciudad", address_hint: "Busca la dirección: el edificio se crea automáticamente según OpenStreetMap.", contact_lbl: "Datos de contacto", add_contact: "＋ Añadir contacto", contact_hint: "Los visitantes no registrados ven los datos solo de forma parcial. Los usuarios con sesión los ven completos.",
      a11y_link: "Declaración de accesibilidad", cancel: "Cancelar", confirm: "Confirmar", lead_share: "Acepto que mi consulta también pueda enviarse a otros agentes y proveedores que puedan ofrecerme propiedades similares o financiación. Marcarlo es opcional: la consulta llega al propietario igualmente.",
      ...
      floors_total_lbl: "De cuántas plantas", category_lbl: "Uso", residential: "Residencial", commercial: "Comercial", agricultural: "Agrícola", farm: "Granja", orchard: "Huerto", vineyard: "Viñedo", field: "Campo / tierra agrícola", penthouse: "Ático", studio: "Estudio", office: "Oficina", shop: "Local", warehouse: "Almacén", other_type: "Otro",
