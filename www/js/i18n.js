...
(function () {
  ...
  const T = {
    he: {
      ...
      ev_new_listing: "נכס חדש פורסם בבניין", ev_price_drop: "ירידת מחיר בנכס בבניין", ev_sold: "נכס בבניין סומן כנמכר", ev_frozen: "נכס בבניין הוקפא", rt_today: "היום", rt_yesterday: "אתמול",
