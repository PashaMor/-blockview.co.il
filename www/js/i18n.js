...
(function () {
  ...
  const T = {
    he: {
      ...
      floors_total_lbl: "מתוך כמה קומות", category_lbl: "ייעוד", residential: "מגורים", commercial: "מסחרי", agricultural: "חקלאי", farm: "משק חקלאי", orchard: "מטע", vineyard: "כרם", field: "שדה / קרקע חקלאית", pick_on_map: "📍 בחר מיקום על המפה", pick_hint: "מקם את הסימון על המשק ואשר", address_ph_farm: "יישוב / עיר", farm_here: "משק חקלאי (מיקום נבחר)", pin_set: "מיקום נבחר על המפה", penthouse: "פנטהאוז", studio: "סטודיו", office: "משרד", shop: "חנות", warehouse: "מחסן / לוגיסטיקה", other_type: "אחר",
