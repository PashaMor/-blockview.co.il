...
(function () {
  ...
  const T = {
    he: {
      ...
      save: "♥ שמור", share: "🔗 שתף", send_msg: "שליחת הודעה", language: "שפה", for_sale: "למכירה", for_rent: "להשכרה", rent_term: "תקופת השכירות", term_short: "קצר טווח", term_long: "ארוך טווח", term_hint: "קצר טווח — השכרה לימים או שבועות. ארוך טווח — חוזה שכירות רגיל.",
