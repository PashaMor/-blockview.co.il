...
(function () {
  ...
  const T = {
    ...
    ru: {
      ...
      publish: "Разместить объект", who_q: "Кто вы?", who_sub: "Выберите, как продолжить", owner: "Собственник", owner_desc: "Разместите свой объект сами", realtor: "Риелтор / агент", realtor_desc: "Перейти в CRM для агентов", publish_title: "Размещение объекта", publish_sub: "Объявление проходит модерацию и появляется на карте.", pub_title_lbl: "Заголовок", price_lbl: "Цена (₪)", size_lbl: "м²", floor_lbl: "Этаж", photos_lbl: "Фото", submit_listing: "Отправить на модерацию", login_to_publish: "Войдите, чтобы разместить", pub_ok: "Отправлено на модерацию ✓",
    },
    es: {
      ...
      publish: "Publicar propiedad", who_q: "¿Quién eres?", who_sub: "Elige cómo continuar", owner: "Propietario", owner_desc: "Publica tu propia propiedad", realtor: "Agente inmobiliario", realtor_desc: "Ir al CRM de agentes", publish_title: "Publicar propiedad", publish_sub: "Tu anuncio se revisa y luego aparece en el mapa.", pub_title_lbl: "Título", price_lbl: "Precio (₪)", size_lbl: "m²", floor_lbl: "Piso", photos_lbl: "Fotos", submit_listing: "Enviar a aprobación", login_to_publish: "Inicia sesión para publicar", pub_ok: "Enviado a aprobación ✓",
    },
  };
